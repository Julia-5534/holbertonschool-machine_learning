...
class Yolo:
    ...
    def predict(self, folder_path):
        """
        Make predictions on images in a folder.

        Args:
            folder_path (str): Path to the folder holding
            all the images to predict.

        Returns:
            tuple: A tuple of (predictions, image_paths).
        ...
        # Initialize lists to store predictions and image paths
        predictions = []
        image_paths = []
        ...
        for image_path in image_paths:
            ...
            boxes, box_classes, box_scores = self.predict_image(image)

            # Add prediction and image path to the lists
            ...
            self.show_boxes(image, boxes, box_classes, box_scores, filename)
